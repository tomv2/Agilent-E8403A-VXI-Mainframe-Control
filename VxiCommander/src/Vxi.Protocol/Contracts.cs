...
public static class ProtocolConstants { public const int Version = 2; }
...
public sealed record InstrumentAddress(
    ...
    int? PhysicalSlot=null,
    int? LogicalAddress=null,
    int? SwitchboxCardNumber=null);

public sealed record InstrumentInstance(
    string Id,
    string FriendlyName,
    string DriverId,
    string Manufacturer,
